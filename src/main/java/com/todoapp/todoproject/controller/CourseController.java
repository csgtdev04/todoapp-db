...
//    @PostMapping("/addCourseByUsername/{username}")
//    public Course addCourseByUsername(@RequestBody Course course, @PathVariable String username) {
////        logger.info("Course object {}", course.toString());
//        return courseService.saveCourseForUsername(course);
//    }
